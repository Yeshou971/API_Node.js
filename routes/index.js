...
const getMiddleware = require('../middlewares/get.middleware')
const getMiddlewareReviews = require('../middlewares/get.middleware.reviews')
...
router.post('/change-password', postMiddlewareResetPassword, postControllerResetPassword)
